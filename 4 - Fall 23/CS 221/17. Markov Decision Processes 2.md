...
![[attachments/Untitled 104.png|Untitled 104.png]]
...
![[attachments/Untitled 1 70.png|Untitled 1 70.png]]
...
- We start by just running an **arbitrary policy** to collect some data. Then, we estimate
    ...
    ![[attachments/Untitled 2 70.png|Untitled 2 70.png]]
...
![[attachments/Untitled 3 70.png|Untitled 3 70.png]]
...
![[attachments/Untitled 4 67.png|Untitled 4 67.png]]
...
![[attachments/Untitled 5 67.png|Untitled 5 67.png]]
...
- Notice that we are just trying to find $\hat{T}$﻿ and $\hat{Reward}$﻿ so that we can calculate the estimate for $\hat{Q}_\text{opt}$﻿ because we need that for value iteration.
    ...
    ![[attachments/Untitled 6 66.png|Untitled 6 66.png]]
...
![[attachments/Untitled 7 64.png|Untitled 7 64.png]]

### Average of Utilities

- Similar to before, we collect some data following some policy $\pi$﻿
    
    ![[attachments/Untitled 8 61.png|Untitled 8 61.png]]
...
- Suppose we run multiple episodes of our reinforcement learning algorithm and we got various occurences of state and action pairs $(s, a)$﻿.
    - We want to find estimate $\hat{Q}_\pi (s, a)$﻿. Note that $Q_\pi(s, a)$﻿ is the true value.
        ...
        ![[attachments/Untitled 9 59.png|Untitled 9 59.png]]
...
- With that in mind, we can basically find the expected utility by taking an average of the utilities of each state and action pair $(s, a)$﻿ that we have in our episodes.
    ...
    ![[attachments/Untitled 10 57.png|Untitled 10 57.png]]
    
    - Notice that we only consider the utility of the first occurence of $(s, a)$﻿ in that episode.
    
    ![[attachments/Untitled 11 56.png|Untitled 11 56.png]]
...
- In this episode, we get an estimate for our $Q_\pi(in, stay)$﻿ to be 4.
    ...
    ![[attachments/Untitled 12 55.png|Untitled 12 55.png]]
    
- In this episode, we update our policy for $Q_\pi(in, stay)$﻿
    
    ![[attachments/Untitled 13 53.png|Untitled 13 53.png]]
    
- In this episode, we run it again, and update our $Q_{\pi}$﻿ again.
    
    ![[attachments/Untitled 14 51.png|Untitled 14 51.png]]
    

![[attachments/Untitled 15 49.png|Untitled 15 49.png]]
...
![[attachments/Untitled 16 47.png|Untitled 16 47.png]]

![[attachments/Untitled 17 44.png|Untitled 17 44.png]]

- This is basically the average of the utilities.

### Stochastic gradient descent

![[attachments/Untitled 18 42.png|Untitled 18 42.png]]
...
![[attachments/Untitled 23 28.png|Untitled 23 28.png]]
...
![[attachments/Untitled 24 27.png|Untitled 24 27.png]]

## On and Off Policy

![[attachments/Untitled 25 24.png|Untitled 25 24.png]]
...
![[attachments/Untitled 26 21.png|Untitled 26 21.png]]
...
- In exploitation, we greedily explore until we find a good state, then we just stay there and exploit it.
    ...
    ![[attachments/Untitled 27 19.png|Untitled 27 19.png]]
...
- In exploration, we just explore all the time. We don’t stay and exploit any positions. This essentially says that $\pi_{act}$﻿ is the policy that randomly moves around.
    ...
    ![[attachments/Untitled 28 17.png|Untitled 28 17.png]]
...
![[attachments/Untitled 29 16.png|Untitled 29 16.png]]
...
![[attachments/Untitled 30 16.png|Untitled 30 16.png]]

- WIth how we are learning so far with Q-learning, it does not scale very well.
    
    ![[attachments/Untitled 31 14.png|Untitled 31 14.png]]
...
![[attachments/Untitled 32 14.png|Untitled 32 14.png]]
...
![[attachments/Untitled 33 14.png|Untitled 33 14.png]]