...
![[Pasted image 20250211135242.png]]
...
* Key advantages over 1-bit prediction:
	...
	* Better handles loops and branches that are usually but not always taken
...
* The state transitions on each branch outcome:
	...
	* States 0 and 3 require two opposite outcomes to change primary prediction
