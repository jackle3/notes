...
![Pasted image 20250218133311](Pasted%20image%2020250218133311.png)

### Cache Write Policies
![Pasted image 20250218133433](Pasted%20image%2020250218133433.png)
...
![Pasted image 20250218133611](Pasted%20image%2020250218133611.png)
...
* This is the set of actions we do when we hit a write-miss:
	* Write-invalidate is only for direct-mapped caches because
	...
	![Pasted image 20250218134153](Pasted%20image%2020250218134153.png)
### Typical Choices
* Write-back caches:
...
![Pasted image 20250218135451](Pasted%20image%2020250218135451.png)

## Cache Datapath
* Cache outputs hit if valid bit (V) is set and tag matches address tag
![Pasted image 20250218135709](Pasted%20image%2020250218135709.png)

## Control Signals
![Pasted image 20250218135647](Pasted%20image%2020250218135647.png)
![Pasted image 20250218135653](Pasted%20image%2020250218135653.png)

## Cache Controller FSM
![Pasted image 20250218135746](Pasted%20image%2020250218135746.png)
...
![Pasted image 20250218140942](Pasted%20image%2020250218140942.png)
...
![Pasted image 20250220133823](Pasted%20image%2020250220133823.png)

## MSI Coherence Protocol
* MSI (Modified, Shared, Invalid) protocol for write-back caches
![Pasted image 20250218141229](Pasted%20image%2020250218141229.png)
* States:
...
![Pasted image 20250218143154](Pasted%20image%2020250218143154.png)
...
![Pasted image 20250218144807](Pasted%20image%2020250218144807.png)
* We need to order these loops correctly in order to have cache friendly performance.
![Pasted image 20250218144832](Pasted%20image%2020250218144832.png)
