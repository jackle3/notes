...
![[Pasted image 20250123134907.png]]

# 1. Compiler
* The compiler convert high-level languages to machine code!
![[Pasted image 20250123134924.png]]
* **Front-end (analysis)**
...
![[Pasted image 20250123135349.png]]

## Type Checking
* Use the AST, the semantic analyzer checks for type errors.
![[Pasted image 20250123135427.png]]

## Intermediate Representation
![[Pasted image 20250123135446.png]]
...
![[Pasted image 20250123140943.png]]
* **Function inlining**
...
![[Pasted image 20250123141550.png]]
...
## Pseudoinstructions
![[Pasted image 20250123143841.png]]
## Object File
![[Pasted image 20250123144116.png]]
...
![[Pasted image 20250123142048.png]]
...
* These map directly to electrical signals:
	* 1 (TRUE) = high voltage
	* 0 (FALSE) = low voltage
![[Pasted image 20250123142210.png]]
...
![[Pasted image 20250123142217.png]]
...
![[Pasted image 20250123142339.png]]
...
![[Pasted image 20250123142411.png]]

## Specifying Logic Functions: From Requirements to Circuits
* Two main ways to specify what we want our circuit to do:
	1. **Logic Diagram**: Drawing the actual gates and connections![[Pasted image 20250123142426.png]]
	2. **Truth Table**: Listing all possible inputs and desired outputs![[Pasted image 20250123142448.png]]
...
![[Pasted image 20250123144814.png]]
...
![[Pasted image 20250123142726.png]]
...
![[Pasted image 20250123142737.png]]
...
![[Pasted image 20250123142802.png]]
...
![[Pasted image 20250123142955.png]]
...
![[Pasted image 20250123151316.png]]
...
![[Pasted image 20250123151501.png]]
...
![[Pasted image 20250123151549.png]]
...
* Two key timing requirements:
	* **Setup** time ($t_s$): Data must be stable BEFORE clock edge
		...
		* Can usually be resolved by increasing the clock period because this means the longest chunkc of combinational logic is taking too long to get to the flip-flop.
...
![[Pasted image 20250123151715.png]]
...
* Each SRAM cell (storing 1 bit) uses 6 transistors:
	* Two cross-coupled inverters form a stable loop
		* Think of it like two people each holding one end of a rope
		* They maintain the stored value (0 or 1) as long as power is on
	* Two access transistors act like gates
		* When word line is high: connects cell to bit lines (reading/writing)
		* When word line is low: cell maintains stored value
![[Pasted image 20250123152013.png]]
* Key advantages:
...
![[Pasted image 20250123152104.png]]
* Key advantages:
...
![[Pasted image 20250123152132.png]]
...
![[Pasted image 20250123155716.png]]
...
![[Pasted image 20250123155721.png]]
