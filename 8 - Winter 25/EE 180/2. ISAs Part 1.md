...
![[Pasted image 20250109151507.png|700]]
...
![[Pasted image 20250109151706.png|700]]
...
![[Pasted image 20250109152054.png|700]]

## Instruction Formats
* **Program:** a sequence of instructions
* **Instruction:** a 32-bit sequence stored in memory. There are three formats:
	* Register format
		![[Pasted image 20250109152253.png|700]]
	* Immediate format
		![[Pasted image 20250109152303.png|700]]
	* Jump format
		![[Pasted image 20250109152310.png|700]]
...
![[Pasted image 20250109152406.png|700]]![[Pasted image 20250109152503.png|700]]

# C Vs MIPS I Interface
![[Pasted image 20250109152515.png|700]]

# Why Registers?
![[Pasted image 20250109152601.png|700]]

## RISC Vs CISC
![[Pasted image 20250109152610.png|700]]
...
## Register Naming
![[Pasted image 20250109152735.png|700]]

# Instructions
![[Pasted image 20250109152748.png|700]]

# Arithmetic Instructions
![[Pasted image 20250109152852.png|700]]

## Complex Operations
* For more complex operations, we can break it up into multiple instructions and use temporary registers
![[Pasted image 20250109152907.png|700]]

## Arithmetic Overflow
* We need to work with both signed and unsigned numbers, both of which can overflow.
![[Pasted image 20250109152943.png|700]]
![[Pasted image 20250109152948.png|700]]
![[Pasted image 20250109153008.png|700]]

## Constants
* To perform constant operations, we can use **immediate instructions**
![[Pasted image 20250109153039.png|700]]
...
![[Pasted image 20250109153109.png|700]]

# Logical Instructions
![[Pasted image 20250109153156.png|700]]
...
![[Pasted image 20250109153322.png|700]]
...
![[Pasted image 20250109153531.png|700]]

# Data Transfer
* All accesses between registers and memory happen via `load` and `store`
![[Pasted image 20250109153549.png|700]]

## Instructions
![[Pasted image 20250109153617.png|700]]
...
![[Pasted image 20250109153802.png|700]]

* We don't need an offset here because we precompute the offset using the variable.
![[Pasted image 20250109153816.png|700]]

## Storing Data
![[Pasted image 20250109153847.png|700]]
![[Pasted image 20250109153856.png|700]]
![[Pasted image 20250109153901.png|700]]
...
![[Pasted image 20250109154038.png|700]]
...
![[Pasted image 20250109154104.png|700]]
