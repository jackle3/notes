...
## Galois Counter Mode
* This is [](8%20-%20Winter%2025/CS%20255/5.%20CPA%20Security.md#Nonce-based%20Encryption|nonce-based%20counter%20mode) encryption (which is CPA secure), then we compute a Carter-Wegman MAC on the ciphertext.
