...
![[attachments/Untitled 129.png|Untitled 129.png]]

- The above structure is the same for the other peer.

![[attachments/Untitled 1 93.png|Untitled 1 93.png]]
...
- First, both peers send a message to each other.
    - This is Peer A
        ...
        ![[attachments/Untitled 2 93.png|Untitled 2 93.png]]
        
    - This is Peer B
        
        ![[attachments/Untitled 3 93.png|Untitled 3 93.png]]
    ...
    - Below is a representation of what Peer B received from Peer A, along with the seqno
        ...
        ![[attachments/Untitled 4 89.png|Untitled 4 89.png]]
        
- Then, after sending and receiving each other’s message, both peers will send another TCP segment message
    - This is Peer A
        
        ![[attachments/Untitled 5 89.png|Untitled 5 89.png]]
        
    - This is Peer B
        
        ![[attachments/Untitled 6 88.png|Untitled 6 88.png]]
...
- Now, suppose that the application on peer B did not close the bytestream, and instead pushed `push("not")` into the stream.
    ...
    - This is Peer B
        ...
        ![[attachments/Untitled 7 85.png|Untitled 7 85.png]]
        
    - This is Peer A
        
        ![[attachments/Untitled 8 79.png|Untitled 8 79.png]]
...
- If we now have message 1 arriving first, we can send back a better acknowledgement, and only use 4 messages.
    - This is Peer A
        ...
        ![[attachments/Untitled 9 75.png|Untitled 9 75.png]]
        
    - This is Peer B
        
        - This side only sends message 2, and then receives message 3 from the peer, then its done.
        
        ![[attachments/Untitled 10 71.png|Untitled 10 71.png]]
...
- If we want a message to go to both sides, when they both just opened, we need three messages.
    ...
    ![[attachments/Untitled 11 69.png|Untitled 11 69.png]]
...
![[attachments/Untitled 12 68.png|Untitled 12 68.png]]
...
![[attachments/Untitled 13 66.png|Untitled 13 66.png]]

![[attachments/Untitled 14 62.png|Untitled 14 62.png]]
...
- Once the three segments above are sent and received, both peers know that they themselves are finished, and that their peer is also finished.
    ...
    ![[attachments/Untitled 15 60.png|Untitled 15 60.png]]
...
![[attachments/Untitled 16 56.png|Untitled 16 56.png]]
