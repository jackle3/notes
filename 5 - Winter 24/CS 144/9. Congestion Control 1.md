...
- Below is the stack that we’re considering so far.
    ...
    ![[attachments/Untitled 124.png|Untitled 124.png]]
...
![[attachments/Untitled 1 88.png|Untitled 1 88.png]]
...
![[attachments/Untitled 2 88.png|Untitled 2 88.png]]

- This diagram is what the **receiver** sees.

![[attachments/Untitled 3 88.png|Untitled 3 88.png]]

- This diagram is what the **sender** sees.

![[attachments/Untitled 4 84.png|Untitled 4 84.png]]

# Windows

- The window serves as the **cap on the number of outstanding bytes**

![[attachments/Untitled 5 84.png|Untitled 5 84.png]]
...
- In the case below, the propagation delays are 1 second there and back.
    ...
    ![[attachments/Untitled 6 83.png|Untitled 6 83.png]]
...
![[attachments/Untitled 7 80.png|Untitled 7 80.png]]

- This **does not affect correctness** → eventually, the stream will be received correctly.

# Issue with congestion: Collapse

![[attachments/Untitled 8 75.png|Untitled 8 75.png]]

- As the demand grows past a certain point, the amount of useful work collapses.

![[attachments/Untitled 9 71.png|Untitled 9 71.png]]

![[attachments/Untitled 10 67.png|Untitled 10 67.png]]
...
- As long as the second link is never doing duplicate work **and** never wasted, you can’t get congestion collapse.
    ...
    ![[attachments/Untitled 11 65.png|Untitled 11 65.png]]
...
- Another way to get collapse is to try to waste resources. Below is an example, where we now have two hops and two routers.
    ...
    ![[attachments/Untitled 12 64.png|Untitled 12 64.png]]
    
    - If we add another sender and receiver to the above example, we can more clearly see collapse.
    
    ![[attachments/Untitled 13 62.png|Untitled 13 62.png]]
...
![[attachments/Untitled 14 58.png|Untitled 14 58.png]]

![[attachments/Untitled 15 56.png|Untitled 15 56.png]]
...
![[attachments/Untitled 16 53.png|Untitled 16 53.png]]
...
![[attachments/Untitled 17 50.png|Untitled 17 50.png]]

- Depending on how we define the utility/happiness function, we can achieve any of the fairness policies defined above.

## Alpha-fairness

![[attachments/Untitled 18 48.png|Untitled 18 48.png]]

## Other objectives

![[attachments/Untitled 19 44.png|Untitled 19 44.png]]
...
![[attachments/Untitled 20 43.png|Untitled 20 43.png]]