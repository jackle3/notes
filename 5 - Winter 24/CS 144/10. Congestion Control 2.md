...
![[attachments/Untitled 127.png|Untitled 127.png]]
...
![[attachments/Untitled 1 91.png|Untitled 1 91.png]]
...
![[attachments/Untitled 4 87.png|Untitled 4 87.png]]

- If we consider the scenario from before, where the RTT is 100ms and r = 625 kbyte/s
    
    ![[attachments/Untitled 5 87.png|Untitled 5 87.png]]
    ...
    ![[attachments/Untitled 6 86.png|Untitled 6 86.png]]
    

# Self-clocking

![[attachments/Untitled 7 83.png|Untitled 7 83.png]]
...
- Suppose we are using the same network as before, and the window starts out at 62.5 kbytes.
    ...
    ![[attachments/Untitled 8 77.png|Untitled 8 77.png]]
...
- After 100ms (RTT), sender will receive acknowledgement for the first segment that it sent.
    ...
    ![[attachments/Untitled 9 73.png|Untitled 9 73.png]]
...
- 2.4ms after the first ack received (serialization delay of segment), sender will receive another acnowledgement for the next segment.
    ...
    ![[attachments/Untitled 10 69.png|Untitled 10 69.png]]
...
- The values necessary to find the ideal congestion window are unknown at runtime!
    ...
    ![[attachments/Untitled 11 67.png|Untitled 11 67.png]]
...
![[attachments/Untitled 12 66.png|Untitled 12 66.png]]

- On success, increase window size by 1 segment.
- On loss, halve the window size.

![[attachments/Untitled 13 64.png|Untitled 13 64.png]]

- Start with a small congestion window size

![[attachments/Untitled 14 60.png|Untitled 14 60.png]]
...
![[attachments/Untitled 15 58.png|Untitled 15 58.png]]
...
- We know that later segments are acknowledged while earlier has not if we receive duplicate acknowledgement numbers.
    ...
    ![[attachments/Untitled 16 55.png|Untitled 16 55.png]]
...
![[attachments/Untitled 17 52.png|Untitled 17 52.png]]
...
![[attachments/Untitled 18 50.png|Untitled 18 50.png]]
...
2. In the output queue at the router / bottleneck.
    1. Below is what the congestion window looks like from the sender’s POV
        ...
        ![[attachments/Untitled 19 46.png|Untitled 19 46.png]]
    ...
    2. Below is what the queue occupancy looks like from the router’s POV
        ...
        ![[attachments/Untitled 20 45.png|Untitled 20 45.png]]
