...
![[attachments/Untitled 122.png|Untitled 122.png]]
...
![[attachments/Untitled 1 86.png|Untitled 1 86.png]]
...
![[attachments/Untitled 2 86.png|Untitled 2 86.png]]

# Queueing Delay

![[attachments/Untitled 3 86.png|Untitled 3 86.png]]

- We have to take into account the queueing delay on the router.
    
    ![[attachments/Untitled 4 82.png|Untitled 4 82.png]]
    
- Note that the queue is out the outbound link.
    
    ![[attachments/Untitled 5 82.png|Untitled 5 82.png]]
...
- The sender would have to worry about queuing delay on when the output rate is slower than the input rate.
    ...
    ![[attachments/Untitled 6 81.png|Untitled 6 81.png]]
...
![[attachments/Untitled 7 78.png|Untitled 7 78.png]]
...
- Below is a simple model of a router queue.
    ...
    ![[attachments/Untitled 8 73.png|Untitled 8 73.png]]
...
- If the router is connected to multiple links, each one has an output queue
    ...
    ![[attachments/Untitled 9 69.png|Untitled 9 69.png]]
...
- Below is a graph of the cumulatively number of bytes.
    ...
    ![[attachments/Untitled 10 66.png|Untitled 10 66.png]]
    
- $Q(t)$﻿ is defined as $A(t) - D(t)$﻿ → queue is the number of packets waiting in the router.
    
    ![[attachments/Untitled 11 64.png|Untitled 11 64.png]]
...
![[attachments/Untitled 12 63.png|Untitled 12 63.png]]
...
![[attachments/Untitled 13 61.png|Untitled 13 61.png]]
...
- In our case, the average occupancy of the queue during the 1 second interval is `137.5 bits`
    ...
    ![[attachments/Untitled 14 57.png|Untitled 14 57.png]]
...
![[attachments/Untitled 15 55.png|Untitled 15 55.png]]
