...
![[attachments/Untitled 207.png|Untitled 207.png]]
...
![[attachments/Untitled 1 170.png|Untitled 1 170.png]]
...
![[attachments/Untitled 2 169.png|Untitled 2 169.png]]
...
![[attachments/Untitled 3 166.png|Untitled 3 166.png]]
...
![[attachments/Untitled 4 161.png|Untitled 4 161.png]]
...
![[attachments/Untitled 5 158.png|Untitled 5 158.png]]

## Conversational Question Answering

- Build questions on top of each other. The LLM must be able to remember the previous answers.

![[attachments/Untitled 6 156.png|Untitled 6 156.png]]
...
![[attachments/Untitled 7 152.png|Untitled 7 152.png]]
...
![[attachments/Untitled 8 143.png|Untitled 8 143.png]]
...
![[attachments/Untitled 9 139.png|Untitled 9 139.png]]

## Stanford Attentive Reader

![[attachments/Untitled 10 133.png|Untitled 10 133.png]]
...
- Once we have the representation for both, we use attention and joint their representations to get our predictions.
    ...
    ![[attachments/Untitled 13 116.png|Untitled 13 116.png]]
...
![[attachments/Untitled 14 103.png|Untitled 14 103.png]]
...
![[attachments/Untitled 15 98.png|Untitled 15 98.png]]

- We can visualize the attention:
    
    - Each row is a query word, each column is a context word.
    
    ![[attachments/Untitled 16 92.png|Untitled 16 92.png]]
...
![[attachments/Untitled 17 86.png|Untitled 17 86.png]]
...
- The goal is still to predict the start and end token in the context.
    ...
    ![[attachments/Untitled 18 78.png|Untitled 18 78.png]]
    
- The loss function will have to be jointly-optimized between the start and end tokens.
    
    ![[attachments/Untitled 19 70.png|Untitled 19 70.png]]
...
- BERT is very simple. People tend to train all of the BERT parameters as well as the newly introduced ones for the classifiers.
    ...
    ![[attachments/Untitled 20 66.png|Untitled 20 66.png]]
    

## Comparison between BERT and BiDAF

![[attachments/Untitled 21 60.png|Untitled 21 60.png]]
...
![[attachments/Untitled 22 55.png|Untitled 22 55.png]]

- There are modern tests that measure the failure rate of models on certain difficult tasks.
    
    ![[attachments/Untitled 23 51.png|Untitled 23 51.png]]
...
![[attachments/Untitled 24 47.png|Untitled 24 47.png]]

## Reriever-Reader framework

![[attachments/Untitled 25 42.png|Untitled 25 42.png]]
...
![[attachments/Untitled 26 37.png|Untitled 26 37.png]]
...
![[attachments/Untitled 27 33.png|Untitled 27 33.png]]
...
![[attachments/Untitled 28 31.png|Untitled 28 31.png]]
...
- One modern work is REALM: retrieval-augmented LM
    ...
    ![[attachments/Untitled 29 30.png|Untitled 29 30.png]]
    ...
    - We use the law of total probability to expand this probability.
        ...
        - This is a pretty expensive operation because we have to enumerate through all articles in $Z$﻿
            ...
            ![[attachments/Untitled 30 30.png|Untitled 30 30.png]]
            
- To find $p(z | x)$﻿, we can represent the input and the document as embeddings.
    
    ![[attachments/Untitled 31 26.png|Untitled 31 26.png]]
    
- To find $p(y | z, x)$﻿ → we need to enumerate over all the $z$﻿ to get a good $y$﻿ output.
    
    ![[attachments/Untitled 32 26.png|Untitled 32 26.png]]
...
![[attachments/Untitled 35 18.png|Untitled 35 18.png]]
...
![[attachments/Untitled 36 17.png|Untitled 36 17.png]]

# LLMs cannot memorize everything

- There is a limit to the context that it remembers.

![[attachments/Untitled 37 17.png|Untitled 37 17.png]]
...
![[attachments/Untitled 38 16.png|Untitled 38 16.png]]
...
![[attachments/Untitled 39 15.png|Untitled 39 15.png]]
...
![[attachments/Untitled 40 14.png|Untitled 40 14.png]]
