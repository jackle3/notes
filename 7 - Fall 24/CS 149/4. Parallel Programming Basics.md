...
![Pasted image 20241005165221](Pasted%20image%2020241005165221.png)
...
![Pasted image 20241005165233](Pasted%20image%2020241005165233.png)
# 1. Decomposition
...
![Pasted image 20241005170109](Pasted%20image%2020241005170109.png)
...
![Pasted image 20241005165737](Pasted%20image%2020241005165737.png)

* **First strategy:** parallelize step 1 because there's no dependencies there.

| ![Pasted image 20241005165810](Pasted%20image%2020241005165810.png) | ![Pasted image 20241005165815](Pasted%20image%2020241005165815.png) | ![Pasted image 20241005165829](Pasted%20image%2020241005165829.png) |
| ------------------------------------ | ------------------------------------ | ------------------------------------ |


* **Second strategy:** compute partial sums of image in parallel, combine results serially

| ![Pasted image 20241005165921](Pasted%20image%2020241005165921.png) | ![Pasted image 20241005165929](Pasted%20image%2020241005165929.png) | ![Pasted image 20241005165935](Pasted%20image%2020241005165935.png) |
| ------------------------------------ | ------------------------------------ | ------------------------------------ |
...
![Pasted image 20241005170351](Pasted%20image%2020241005170351.png)
...
![Pasted image 20241005170519](Pasted%20image%2020241005170519.png)
...
# Grid Solver Example
![Pasted image 20241005170906](Pasted%20image%2020241005170906.png)
...
![Pasted image 20241005171035](Pasted%20image%2020241005171035.png)
## 1. Decomposition
...
![Pasted image 20241005171434](Pasted%20image%2020241005171434.png)
...
![Pasted image 20241005171516](Pasted%20image%2020241005171516.png)
...
![Pasted image 20241005171914](Pasted%20image%2020241005171914.png)

## 2. Assignment
![Pasted image 20241005172056](Pasted%20image%2020241005172056.png)

* Notice that in this program, there is a lot of inter-processor communication.
![Pasted image 20241005172154](Pasted%20image%2020241005172154.png)
...
![Pasted image 20241005172311](Pasted%20image%2020241005172311.png)
...
![Pasted image 20241005172904](Pasted%20image%2020241005172904.png)
...
![Pasted image 20241008132159](Pasted%20image%2020241008132159.png)

### Synchronization
* All threads **share** the same address space, so they can communicate via **shared variables**
![Pasted image 20241008133546](Pasted%20image%2020241008133546.png)
### Locks
* We need to coordinate access to shared variables via locks.
![Pasted image 20241008133658](Pasted%20image%2020241008133658.png)
* Operations on shared variables **must be atomic**
![Pasted image 20241008134652](Pasted%20image%2020241008134652.png)
...
| ![Pasted image 20241008135504](Pasted%20image%2020241008135504.png)        | ![Pasted image 20241008135518](Pasted%20image%2020241008135518.png) |
| ------------------------------------------- | ------------------------------------ |
...
![Pasted image 20241008151143](Pasted%20image%2020241008151143.png)