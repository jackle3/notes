...
* Each sub-core has a bunch of execution contexts (aka threads)
	* In this case, each execution context is a vertical group of four in the blue registers.
	* Notice that we have $128$ execution contexts in this diagram.
* In traditional CPUs, you would think of these registers as **one CPU executon context** with **32-wide vector registers**.
