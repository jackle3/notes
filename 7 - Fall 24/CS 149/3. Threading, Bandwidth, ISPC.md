...
* Core underutilization **is only a function of instruction and memory throughput**.
	...
	* Steady state underutilization is **not a function of # of outstanding memory requests**.
		...
		* The speed at which we can get through this queue is determined by how fast we can finish the blue bar, so again by memory bandiwdth/throughput.![[Pasted image 20241013182517.png]]
