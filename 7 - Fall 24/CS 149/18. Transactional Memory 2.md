...
![[Pasted image 20241209200119.png]]
## Advantages
![[Pasted image 20241209200311.png]]
* Transaction will only serialize if there are conflicts ⟶ can be massively parallelized.
## Implementation Basics
![[Pasted image 20241209200401.png]]
...
![[Pasted image 20241209165923.png]]
...
![[Pasted image 20241209170053.png]]
...
![[Pasted image 20241209170406.png]]
...
![[Pasted image 20241209170500.png]]
...
3. Then, insert in read set
4. Then, return value

**STM Write (pessimistic)**
1. Validate data (same as before)
	* Check if unlocked and data version ≤ local timestamp
2. Acquire the write lock on data
3. Insert in write set
4. Create undo log entry
5. Write data into memory (eager)
...
### Example
![[Pasted image 20241209202116.png]]
...
![[Pasted image 20241209203831.png]]
...
![[Pasted image 20241209203940.png]]
...
![[Pasted image 20241209204841.png]]
* When X1 commits:
...
![[Pasted image 20241209205137.png]]
![[Pasted image 20241209205144.png]]
...
![[Pasted image 20241209205220.png]]

### Summary
![[Pasted image 20241209205402.png]]
...
# Hardware TM
![[Pasted image 20241209205911.png]]
...
![[Pasted image 20241209210158.png]]
...
![[Pasted image 20241209210334.png]]

**Transaction Begin**
![[Pasted image 20241209210359.png]]

**Load Operation**
![[Pasted image 20241209210406.png]]
![[Pasted image 20241209210511.png]]
...
![[Pasted image 20241209210958.png]]

**Detect/Abort**
![[Pasted image 20241209211159.png]]

## Example: Transactional Coherence and Consistency
![[Pasted image 20241209211450.png]]

* When T2 commits, T4 is aborted because it read `E` which T2 wrote.
![[Pasted image 20241209211512.png]]
