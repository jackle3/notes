...
![300](Pasted%20image%2020241122123953.png)
### Deadlock in Systems
![Pasted image 20241122124227](Pasted%20image%2020241122124227.png)

### Conditions for Deadlock
![Pasted image 20241122124313](Pasted%20image%2020241122124313.png)
...
![Pasted image 20241122124418](Pasted%20image%2020241122124418.png)
...
![Pasted image 20241122124700](Pasted%20image%2020241122124700.png)
...
**Example 2:**
![Pasted image 20241122130104](Pasted%20image%2020241122130104.png)
...
![Pasted image 20241122130208](Pasted%20image%2020241122130208.png)
...
![Pasted image 20241122130242](Pasted%20image%2020241122130242.png)
...
![Pasted image 20241122130944](Pasted%20image%2020241122130944.png)
...
![Pasted image 20241122131331](Pasted%20image%2020241122131331.png)

# Lock Performance
![Pasted image 20241122131357](Pasted%20image%2020241122131357.png)
...
![Pasted image 20241122131446](Pasted%20image%2020241122131446.png)

* There is **no cache contention** while someone else has the lock, because all other processors will have line is **shared** state.
![Pasted image 20241122132121](Pasted%20image%2020241122132121.png)

## Characteristics
![Pasted image 20241122132309](Pasted%20image%2020241122132309.png)
...
![Pasted image 20241122132936](Pasted%20image%2020241122132936.png)

# Compare and Swap
* Compare and swap is an **atomic** general purpose test-and-set
	* If `old` value equals `compare`, set it to the new `val`.
![Pasted image 20241122133531](Pasted%20image%2020241122133531.png)
...
![Pasted image 20241122133542](Pasted%20image%2020241122133542.png)

## Spin Lock
![Pasted image 20241122133958](Pasted%20image%2020241122133958.png)
...
![Pasted image 20241122134330](Pasted%20image%2020241122134330.png)
...
![Pasted image 20241122134543](Pasted%20image%2020241122134543.png)
![Pasted image 20241122134602](Pasted%20image%2020241122134602.png)

### Single Global Lock
* The simplest solution is to **lock** the read and writes to the list.
![Pasted image 20241122134744](Pasted%20image%2020241122134744.png)
![Pasted image 20241122134804](Pasted%20image%2020241122134804.png)
...
![Pasted image 20241122135151](Pasted%20image%2020241122135151.png)
* Then we can release the lock on `3` and move onto `10`
![Pasted image 20241122135210](Pasted%20image%2020241122135210.png)
...
![Pasted image 20241122135223](Pasted%20image%2020241122135223.png)

Suppose now `Thread 1: delete (10)`
* It acquires the lock on `3` and `5` but can't move on until thread 0 finishes.
![Pasted image 20241122135348](Pasted%20image%2020241122135348.png)
* Once thread 0 finishes, then thread 1 can take the locks.
![Pasted image 20241122135423](Pasted%20image%2020241122135423.png)
![Pasted image 20241122135441](Pasted%20image%2020241122135441.png)
![Pasted image 20241122135455](Pasted%20image%2020241122135455.png)

#### Implementation
![Pasted image 20241122135513](Pasted%20image%2020241122135513.png)

#### Characteristics
![Pasted image 20241122135530](Pasted%20image%2020241122135530.png)
