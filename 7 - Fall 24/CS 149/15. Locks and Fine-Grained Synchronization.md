...
![[Pasted image 20241122123953.png|300]]
### Deadlock in Systems
![[Pasted image 20241122124227.png]]

### Conditions for Deadlock
![[Pasted image 20241122124313.png]]
...
![[Pasted image 20241122124418.png]]
...
![[Pasted image 20241122124700.png]]
...
**Example 2:**
![[Pasted image 20241122130104.png]]
...
![[Pasted image 20241122130208.png]]
...
![[Pasted image 20241122130242.png]]
...
![[Pasted image 20241122130944.png]]
...
![[Pasted image 20241122131331.png]]

# Lock Performance
![[Pasted image 20241122131357.png]]
...
![[Pasted image 20241122132936.png]]

# Atomic Compare and Swap
* Compare and swap is a general purpose test-and-set
	* If `old` value equals `compare`, set it to the new `val`.
![[Pasted image 20241122133531.png]]
...
![[Pasted image 20241122133542.png]]

## Spin Lock
![[Pasted image 20241122133958.png]]
...
![[Pasted image 20241122134330.png]]
...
![[Pasted image 20241122134543.png]]
![[Pasted image 20241122134602.png]]

### Single Global Lock
* The simplest solution is to **lock** the read and writes to the list.
![[Pasted image 20241122134744.png]]
![[Pasted image 20241122134804.png]]
...
![[Pasted image 20241122135151.png]]
* Then we can release the lock on `3` and move onto `10`
![[Pasted image 20241122135210.png]]
...
![[Pasted image 20241122135223.png]]

Suppose now `Thread 1: delete (10)`
* It acquires the lock on `3` and `5` but can't move on until thread 0 finishes.
![[Pasted image 20241122135348.png]]
* Once thread 0 finishes, then thread 1 can take the locks.
![[Pasted image 20241122135423.png]]
![[Pasted image 20241122135441.png]]
![[Pasted image 20241122135455.png]]

#### Implementation
![[Pasted image 20241122135513.png]]

#### Characteristics
![[Pasted image 20241122135530.png]]
