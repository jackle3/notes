...
# Roadmap
![Pasted image 20241111133633](Pasted%20image%2020241111133633.png)

## Review: Energy Efficiency Vs Programmability
![Pasted image 20241111134710](Pasted%20image%2020241111134710.png)
...
![Pasted image 20241111140012](Pasted%20image%2020241111140012.png)
![Pasted image 20241111140131](Pasted%20image%2020241111140131.png)
...
| ![Pasted image 20241111140534](Pasted%20image%2020241111140534.png) | ![Pasted image 20241111140454](Pasted%20image%2020241111140454.png)                                                                                                   |
| ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- |
| ![Pasted image 20241111140546](Pasted%20image%2020241111140546.png) | ![Pasted image 20241111140633](Pasted%20image%2020241111140633.png)                                                                                                   |
| ![Pasted image 20241111140640](Pasted%20image%2020241111140640.png) | With a 4x4 W matrix, we need 16 multiplications (the systolic array will have 16 elements).<br><br>A lot of the PEs are underutilized. |
![Pasted image 20241111140941](Pasted%20image%2020241111140941.png)
...
![Pasted image 20241111142611](Pasted%20image%2020241111142611.png)
...
![Pasted image 20241111142957](Pasted%20image%2020241111142957.png)
...
![Pasted image 20241111143145](Pasted%20image%2020241111143145.png)
...
![Pasted image 20241111143326](Pasted%20image%2020241111143326.png)
...
![Pasted image 20241111143559](Pasted%20image%2020241111143559.png)

## The Whole GPU
* Most of the FLOPs are in the systolic arrays in the tensor core
![Pasted image 20241111143853](Pasted%20image%2020241111143853.png)
...
![Pasted image 20241111144041](Pasted%20image%2020241111144041.png)
...
![Pasted image 20241111214008](Pasted%20image%2020241111214008.png)
## Key Principles
![Pasted image 20241111220053](Pasted%20image%2020241111220053.png)
...
![Pasted image 20241111214758](Pasted%20image%2020241111214758.png)
...
* It allows you to reconfigure the chip to match the data flow of the algorithm.
	...
	*
![Pasted image 20241111220745](Pasted%20image%2020241111220745.png)
...
![Pasted image 20241111221248](Pasted%20image%2020241111221248.png)
...
![Pasted image 20241111215630](Pasted%20image%2020241111215630.png)
...
![Pasted image 20241111221831](Pasted%20image%2020241111221831.png)
...
![Pasted image 20241111222132](Pasted%20image%2020241111222132.png)
## Matmul Metapipeline
* The outer pipeline loads tiles from the A matrix.
* The inner pipeline loads tiles from the B matrix and does the matmul.
![Pasted image 20241111222225](Pasted%20image%2020241111222225.png)
...
![Pasted image 20241111222308](Pasted%20image%2020241111222308.png)
...
![Pasted image 20241111222455](Pasted%20image%2020241111222455.png)
...
![Pasted image 20241111222730](Pasted%20image%2020241111222730.png)
...
![Pasted image 20241111223144](Pasted%20image%2020241111223144.png)
...
![Pasted image 20241111223147](Pasted%20image%2020241111223147.png)
* **Drawback:** we need to be able to fit the entire kernel on the chip.

# Summary
![Pasted image 20241111223432](Pasted%20image%2020241111223432.png)
