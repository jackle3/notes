...
![[Pasted image 20241114210149.png|500]]
...
![[Pasted image 20241114210447.png]]
...
![[Pasted image 20241114210945.png]]
...
>
> ![[Pasted image 20241114211233.png]]
> ![[Pasted image 20241114211338.png]]


# Prelim
## Chain Rule
![[Pasted image 20241114211427.png]]


## Notation
![[Pasted image 20241114211650.png]]

****
# Two-Layer NN
* In this NN, we pass in our inputs, then there is a hidden layer, then the output layer.
![[Pasted image 20241114211822.png]]
* Our loss function for a single example is:
![[Pasted image 20241114211852.png|400]]

## Lemma 1: Linear Combination
![[Pasted image 20241114212045.png|400]]
...
![[Pasted image 20241114212552.png]]

* We can apply this lemma to our NN:
![[Pasted image 20241114212739.png]]

## Lemma 2: Activation Function
![[Pasted image 20241114212844.png|400]]

* We can apply this lemma to our NN:
![[Pasted image 20241114212934.png|400]]

## Lemma 3: Output Layer
![[Pasted image 20241114213022.png|400]]

* Applying this our NN, we have:
![[Pasted image 20241114213256.png]]
* where we know what $J(\tau)$ is ⟶ $J(\tau) = \frac{1}{2}(y - \tau)^2$

* We can also use our other lemmas here to compute stuff:
![[Pasted image 20241114213250.png|500]]

# Deep NN
* The equations for each layer are below:
![[Pasted image 20241114213402.png|400]]
...
![[Pasted image 20241114213530.png]]
* By Lemma 1, this is equal to:
![[Pasted image 20241114215547.png]]

## w.r.t Z
* We know that $z^{[k]}$ is used to calculate $a^{[k]}$:
![[Pasted image 20241114215658.png]]
* By Lemma 2, this means that:
![[Pasted image 20241114220114.png]]

## w.r.t A
* We know that $a^{[k]}$ is used to calculate $z^{[k+1]}$
![[Pasted image 20241114220000.png]]
* By Lemma 3, this means that:
![[Pasted image 20241114220009.png]]
...
![[Pasted image 20241114220205.png]]
...
![[Pasted image 20241114220516.png]]
* We keep repeating this for each subsequent layer
![[Pasted image 20241114220614.png]]
...
![[Pasted image 20241114222157.png]]
...
![[Pasted image 20241114222606.png]]
