...
![Pasted image 20241113140710](Pasted%20image%2020241113140710.png)
* In deep learning, our hypothesis is nonlinear in both $\theta$ and $x$
![Pasted image 20241113140716](Pasted%20image%2020241113140716.png)

# General Learning Setup
* We have a dataset and and a hypothesis function.
![Pasted image 20241113140743](Pasted%20image%2020241113140743.png)
* The cost function on the i-th example is the squared loss:
![Pasted image 20241113140842](Pasted%20image%2020241113140842.png)
* The cost function for the whole dataset is the mean squared loss:
![Pasted image 20241113140902](Pasted%20image%2020241113140902.png)
* The optimization objective is thus:
$$
\min_{\theta} J(\theta)
$$
* To optimize this we can use **batch gradient descent:**
![Pasted image 20241113140945](Pasted%20image%2020241113140945.png)
...
![Pasted image 20241113141033](Pasted%20image%2020241113141033.png)
...
![Pasted image 20241113141306](Pasted%20image%2020241113141306.png)
...
![Pasted image 20241113141700](Pasted%20image%2020241113141700.png)
...
![300](Pasted%20image%2020241113142105.png)
* To get a prediction that doesn't go negative for prices, we use ReLU
![Pasted image 20241113142036](Pasted%20image%2020241113142036.png)
* In the **multidimensional** case, the hypothesis is:
![Pasted image 20241113142201](Pasted%20image%2020241113142201.png)
...
![Pasted image 20241113182541](Pasted%20image%2020241113182541.png)
...
![Pasted image 20241113182738](Pasted%20image%2020241113182738.png)
* The hypothesis is thus:
![Pasted image 20241113182759](Pasted%20image%2020241113182759.png)
...
![Pasted image 20241113183043](Pasted%20image%2020241113183043.png)
* We can then calculate the linear combination of input features (prior to activation) as:
![Pasted image 20241113183054](Pasted%20image%2020241113183054.png)
* Then we can write the **hidden layer** output as:
$$
a = \text{ReLU}(z) = \text{ReLU}(W^{[1]}x + b^{[1]})
$$
* The hypothesis is thus:
![Pasted image 20241113183404](Pasted%20image%2020241113183404.png)
...
![Pasted image 20241113183708](Pasted%20image%2020241113183708.png)
* The output of the **output layer** (the hypothesis) is thus:
![Pasted image 20241113183732](Pasted%20image%2020241113183732.png)
...
![Pasted image 20241113184426](Pasted%20image%2020241113184426.png)
...
![Pasted image 20241113184809](Pasted%20image%2020241113184809.png)

## Why not Identity Function?
![Pasted image 20241113184827](Pasted%20image%2020241113184827.png)
