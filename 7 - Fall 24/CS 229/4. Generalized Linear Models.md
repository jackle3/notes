...
![400](Pasted%20image%2020241011171654.png)


## Bernoulli
![400](Pasted%20image%2020241011171452.png)
...
![400](Pasted%20image%2020241011171912.png)

## Gaussian
* To simply the derivation, suppose $\sigma^2 = 1$
![Pasted image 20241011171458](Pasted%20image%2020241011171458.png)
...
## Other Families
![Pasted image 20241011172017](Pasted%20image%2020241011172017.png)
...
![Pasted image 20241029215333](Pasted%20image%2020241029215333.png)
![Pasted image 20241031133506](Pasted%20image%2020241031133506.png)
![Pasted image 20241011172231](Pasted%20image%2020241011172231.png)
![Pasted image 20241011172307](Pasted%20image%2020241011172307.png)
...
![Pasted image 20241011174247](Pasted%20image%2020241011174247.png)
...
![Pasted image 20241011174501](Pasted%20image%2020241011174501.png)
...
![Pasted image 20241011175203](Pasted%20image%2020241011175203.png)
...
![Pasted image 20241011175611](Pasted%20image%2020241011175611.png)
...
![Pasted image 20241011180023](Pasted%20image%2020241011180023.png)

* The **link function:**
![Pasted image 20241011180132](Pasted%20image%2020241011180132.png)

* The **response function** is:
![Pasted image 20241011180159](Pasted%20image%2020241011180159.png)
* The response function mapping the $\phi$'s to the $\eta$'s is the **softmax function**.
![Pasted image 20241011180619](Pasted%20image%2020241011180619.png)
* This equation can also be written as:
$$
p(y = i| x; \theta) = \frac{e^{\theta_{i}^Tx}}{1 + \sum_{j=1}^{k-1}e^{\theta_{j}^Tx}}
$$
![Pasted image 20241011180958](Pasted%20image%2020241011180958.png)
...
![Pasted image 20241011181235](Pasted%20image%2020241011181235.png)
![Pasted image 20241011181219](Pasted%20image%2020241011181219.png)

* If we take the gradient of this, we will eventually get:
![Pasted image 20241011181319](Pasted%20image%2020241011181319.png)

### Summary
![Pasted image 20241011181330](Pasted%20image%2020241011181330.png)
![Pasted image 20241011181340](Pasted%20image%2020241011181340.png)
![Pasted image 20241011181344](Pasted%20image%2020241011181344.png)

## Example: Poisson Regression
* The response variable is $y\in Z$ as parameterized by $\lambda$.
![Pasted image 20241011181647](Pasted%20image%2020241011181647.png)
...
$$
### Parameter Fitting
![Pasted image 20241011181939](Pasted%20image%2020241011181939.png)
