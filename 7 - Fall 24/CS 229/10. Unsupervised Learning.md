...
![Pasted image 20241029194651](attachments/Pasted%20image%2020241029194651.png)
...
![Pasted image 20241029195839](attachments/Pasted%20image%2020241029195839.png)

## Visualization

| 1. Suppose we have a bunch of data with no structures. We run K-means to divide into two clusters.<br>![350](Pasted%20image%2020241025165442.png%5C) | 2. It initially **guesses two random points as cluster centroids**.![350](Pasted%20image%2020241025165510.png%5C)        |
| ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| 3. It puts points into classes based on **distance from the centroids.**<br>![350](Pasted%20image%2020241025165550.png%5C)                           | 4. It then moves the **centroids to the mean of their sets**.<br>![350](Pasted%20image%2020241025165630.png%5C)          |
| 5. It then **reassigns the cluster assignments** based on the new centroids.<br>![350](Pasted%20image%2020241025165658.png%5C)                       | 6. It the computes the cluster centers, and repeats until convergence.<br>![350](Pasted%20image%2020241025165715.png%5C) |
...
![Pasted image 20241029195359](attachments/Pasted%20image%2020241029195359.png)
...
![Pasted image 20241029200002](attachments/Pasted%20image%2020241029200002.png)
* Furthermore, K-means predict circular clusters.
![500](attachments/Pasted%20image%2020241029200215.png)

## Gaussians in M Dimensions
![Pasted image 20241029200239](attachments/Pasted%20image%2020241029200239.png)
![Pasted image 20241029200252](attachments/Pasted%20image%2020241029200252.png)

## Density Estimation
* GMMs are generally used to perform density estimation (e.g. anomaly detection)
![Pasted image 20241029200021](attachments/Pasted%20image%2020241029200021.png)
![Pasted image 20241029200029](attachments/Pasted%20image%2020241029200029.png)
* Given a piece of data, GMMs try to model it by taking the superposition of $k$ Gaussians.
![Pasted image 20241029200037](attachments/Pasted%20image%2020241029200037.png)

## Mixture of Gaussians
* We essentially want to use GMM to answer: what mixture of Gaussians would have generated this data?
![Pasted image 20241029200409](attachments/Pasted%20image%2020241029200409.png)

## GMM Assumption
![Pasted image 20241029200452](attachments/Pasted%20image%2020241029200452.png)

## Summary of GMM Components
* In the image below, $\pi_k$ is the same as $\phi_k$ ⟶ the prob of sampling from $k$-th Gaussian.
![Pasted image 20241029200526](attachments/Pasted%20image%2020241029200526.png)
...
![Pasted image 20241029203807](attachments/Pasted%20image%2020241029203807.png)
## M-step
...
| 1. In the initial position<br>![350](Pasted%20image%2020241027023940.png%5C)                                                             | 2. After the first iteration<br>![350](Pasted%20image%2020241027023951.png%5C)                                                |
| ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| 3. After the second iteration ⟶ at this point green points are more or less convinced.<br>![350](Pasted%20image%2020241027024008.png%5C) | 4. After the sixth iteration ⟶ at this point the blue points are converging<br>![350](Pasted%20image%2020241027024050.png%5C) |
| 5. After the 20th iteration ⟶ pretty much everyone has converged<br>![350](Pasted%20image%2020241027024122.png%5C)                       |                                                                                                                          |
...
![Pasted image 20241029204808](attachments/Pasted%20image%2020241029204808.png)
