...
---
![Pasted image 20241121105253](Pasted%20image%2020241121105253.png)
...
* Loop:
	...
	* $\pi(s) = \arg\max_{a} \left(\sum_{s'}P_{s, a}(s') \cdot V(s') \right)$
---
![Pasted image 20241121105321](Pasted%20image%2020241121105321.png)

# Reinforcement Learning
## Known Dynamics and Rewards
...
### Q1: How Do We learn/represent the Transition Dynamics $P_{s, a}$?
* A1: Physics simulator that gives you dynamics
	![200](Pasted%20image%2020241121112933.png)
...
* E.g. suppose we model our dynamics by a **linear** system:
	...
	* To learn, suppose we treat trajectories as supervised learning:
		![500](Pasted%20image%2020241121113348.png)
...
## Value Iteration and Policy Iteration with Continuous State Spaces
### Q2: How Do We Perform Value Iteration (VI) or Policy Iteration (PI) with Continuous State Spaces?
...
### Solution: Fitted Value Iteration
...
![Pasted image 20241121112029](Pasted%20image%2020241121112029.png)
...
## Model-based RL
### Calculating Dynamics and Rewards
* Suppose we have a few trajectories
![400](Pasted%20image%2020241121110922.png)
