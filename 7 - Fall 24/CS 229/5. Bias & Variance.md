...
![[Pasted image 20241028215951.png]]
![[Pasted image 20241028215957.png]]
![[Pasted image 20241029220303.png]]
![[Pasted image 20241028221914.png]]
...
* **Variance** is when a model has high variability when the data changes.
	...
	* **algorithm’s tendency to learn random things irrespective of the real signal by fitting highly flexible models to the noise/error in the data too closely**
		 ![[Pasted image 20241028220125.png|500]]

* This also applies for classification, where we can focus on the decision boundary.
![[Pasted image 20241028220204.png]]
## Key Equation
![[Pasted image 20241029220226.png]]
![[Pasted image 20241028222208.png]]
![[Pasted image 20241031132801.png]]
![[Pasted image 20241031132812.png]]
# Diagnostics
...
## High Variance
![[Pasted image 20241028220314.png]]
...
## High Bias
![[Pasted image 20241028220322.png]]
...
![[Pasted image 20241028220345.png]]

## Diagnostic Example
![[Pasted image 20241028220335.png]]
# Regularization
* When a model is overfitting (i.e. high variance), regulization can reduce variance/overfitting.
![[Pasted image 20241028220441.png]]
...
![[Pasted image 20241028222304.png]]
...
$$
## L2 Regularization
![[Pasted image 20241029220353.png]]
...
![[Pasted image 20241029220748.png]]

## Varying Lambda
![[Pasted image 20241028220708.png]]
![[Pasted image 20241028220446.png]]
...
![[Pasted image 20241028220803.png]]
...
![[Pasted image 20241028221020.png]]
